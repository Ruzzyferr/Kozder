    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'GoatCounter — çerez kullanmadan sayfa görüntüleme ve toplam ziyaretçi sayacı sağlar; sınırlı teknik bilgileri işler ve IP adreslerini kalıcı olarak saklamaz',
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'GoatCounter — provides cookie-free pageview analytics and the total visitor counter; it processes limited technical information and does not permanently store IP addresses',
